				...
				<div class="card-content">
					<div class="content">
							<div class="field" for="nameInput">
								...
								<div class="control">
									<input required class="input" name="name" id="nameInput" type="text" placeholder="Ingrese su nombre">
								</div>
							</div>
							<div class="field" for="emailInput">
								<label class="label">Correo</label>
								<div class="control">
									<input required class="input" name="email" id="emailInput" type="text" placeholder="Ingrese su correo">
								</div>
							</div>
							<div class="field" for="passwordInput">
								<label class="label">Contraseña </label>
								<div class="control"> 
									<input required class="input" id="passwordInput" name="password" type="password">
								</div>
							</div>
							<div class="field">
